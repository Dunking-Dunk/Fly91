  ...
  return (
    <div className="container mx-auto p-4 bg-white">
      ...
      <div className="flex space-x-2 mb-4 justify-end">
        ...
        >
          Date Range
          {(table.getColumn("requestRaised")?.getFilterValue() ||
            table.getColumn("fulfilled")?.getFilterValue()) && (
            <span className="ml-2 bg-gray-200 px-2 py-1 rounded-full text-xs flex items-center">
              {table.getColumn("requestRaised")?.getFilterValue()} -{" "}
              {table.getColumn("fulfilled")?.getFilterValue()}
              <X
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  clearFilter("requestRaised");
                  clearFilter("fulfilled");
                }}
              />
            </span>
          )}
