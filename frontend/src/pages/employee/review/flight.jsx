      ...
      <div className="flex-1 p-5">
        <div className="bg-white py-10 px-10 rounded-lg shadow-sm">
          ...
          <div className="flex justify-between items-center mb-6, border border-gray-200 rounded-lg p-4 mb-2 bg-[#fafafa]">
            ...
            <div className="flex justify-between items-center mb-6, border border-gray-200 rounded-lg p-2 bg-[#E4F6FD]">
              <img src="https://cdn-icons-png.flaticon.com/512/74/74510.png" className="h-5 w-5 text-gray-500 mr-2" viewBox="0 0 20 20" fill="currentColor" />
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="border border-gray-200 rounded-lg p-4 mb- bg-[#fafafa]">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="border border-gray-200 rounded-lg p-5 bg-[#ffffff]">
                  <span className="text-sm font-medium text-gray-500">ONE WAY</span>
                </div>
              </div>
            </div>
